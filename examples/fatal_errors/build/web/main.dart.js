...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    querySelector: function(selectors) {
      return W.document().querySelector(selectors);
    },
    HtmlElement: {
      "^": "Element;",
    ...
    EventStreamProvider: {
      ...
      forElement$2$useCapture: function(e, useCapture) {
        return W._ElementEventStreamImpl$(e, this._eventType, false, H.getTypeArgumentByIndex(this, 0));
      },
    ...
    _ElementEventStreamImpl: {
      ...
      static: {
        _ElementEventStreamImpl$: function(target, eventType, useCapture, $T) {
          return new W._ElementEventStreamImpl(target, eventType, false, [$T]);
        }
      }
    },
    ...
    "^": "",
    main: [function() {
      J.get$onClick$x(W.querySelector("button")).listen$1(new F.main_closure());
